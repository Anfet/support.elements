 ...
 */
public class PagingFilteredListAdapter<T extends Object> extends FilteredListHolderAdapter<T> {

	private int itemsPerPage = 10;
	private int currentPage = 0;
	private List<T> activePageItems;

	public PagingFilteredListAdapter(Context context, int layoutId, List<T> items) {
