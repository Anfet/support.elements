...
public interface IPresenter<T, X extends RecyclerView.ViewHolder> {
	...
	/**
	 * Вызывается на этапе создания холдера. Поскольку это чистая инициализация - никаких данных о элементе тут нет. Они будут переданы в {@link IPresenter#populateView(Context, RecyclerView.ViewHolder, Object, int)}
	 * @param holder холдер
	 */
